    ...
    <div className="flex gap-4 flex-col sm:flex-row md:flex-row xl:flex-row">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center">
              <IconBlocks className="w-6 h-6 text-purple-500" />
            </div>
      ...
      <Card className="p-3 w-full rounded-3xl dark:border-neutral-800 dark:bg-neutral-900/40">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center">
              <IconLanguage className="w-6 h-6 text-purple-500" />
            </div>
      ...
      <Card className="p-3 w-full rounded-3xl dark:border-neutral-800 dark:bg-neutral-900/40">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center">
              <IconReceiptDollar className="w-6 h-6 text-purple-500" />
            </div>
      ...
      <Card className="p-3 w-full rounded-3xl dark:border-neutral-800 dark:bg-neutral-900/40">
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            <div className="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center">
              <IconShieldCheck className="w-6 h-6 text-purple-500" />
            </div>
